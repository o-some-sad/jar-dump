...
<?= layout_open("Order History") ?>

<br>
<h1 class="font-mono text-4xl text-center">Order History</h1><br><br>
                        ...
                        <tbody class="bg-white text-sm text-center">
                          <?php foreach ($orderContent as $content): ?>
                            <tr class="hover:bg-gray-100">
                              ...
                              <td class="px-4 py-2">
                                <img src="<?= $content['image'] ?>" alt="<?= $content['image'] ?>" class="mx-auto w-16 h-16 flex items-center justify-center">
                              </td>
