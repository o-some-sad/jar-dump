...
<label for="" class="mb-[10px] block text-base font-medium text-dark dark:text-white">
    ...
    <br><h1 class="font-mono text-4xl text-center">Order History</h1><br>
<div class="max-h-46 overflow-x-auto">
  <table class="min-w-full divide-y-2 divide-gray-200">
    <thead class="sticky text-2xl text-center top-0 bg-white ltr:text-left rtl:text-right">
      <tr class="*:font-medium *:text-gray-900 hover:bg-blue-100">
    ...
    <tbody class="divide-y divide-gray-200">
      <!-- <tr class="*:text-gray-900 *:first:font-medium hover:bg-blue-100"> -->
        ...
        <?php foreach ($tableData as $orderInfo): ?>
            <tr class="text-gray-900 font-medium hover:bg-blue-100 font-light text-center">
