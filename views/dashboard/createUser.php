    ...
    <div class="text-white shadow h-full flex items-center justify-center text-xl font-bold w-[700px]">
        ...
        <div class="w-[300px]">
          ...
          <div class="w-[300px]">
            ...
            <input type="text" name="user_email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com">
          </div>
            <!-- <div class="w-[300px]">
          ...
          <div class="w-[300px]">
            ...
            <input type="password" name="user_confirm_password" id="confirm-password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
            <?= isset($_SESSION['errors']['password_match']) ? 'border-red-500' : 'border-gray-300' ?> ...">
          ...
          <div>
          <button type="submit" name="submit_btn" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Save</button>
          </div> 
          <div>
