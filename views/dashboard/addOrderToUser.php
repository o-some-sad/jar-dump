            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="d-flex align-items-center mb-2 p-2 selection-item">
                        ...
                        <input type="hidden" name="selection[<?= $index ?>][productName]" value="<?= $product['name'] ?>">
                        <input type="hidden" name="selection[<?= $index ?>][productCount]" value="<?= $product['count'] ?? 1 ?>">
                        <input type="hidden" name="selection[<?= $index ?>][totalPrice]" value="<?= $totalPrice ?>">
                        
                        <span class="me-2 flex-grow-1"><?= htmlspecialchars($product['name']) ?></span>
                        <span class="badge bg-secondary me-2"><?= htmlspecialchars(number_format($product['price'], 2)) ?> EGP</span>
                ...
                <div class="d-flex flex-wrap gap-3 justify-content-start">
                    ...
                    ?>
                        <form method="POST" class="d-inline">
                            ...
                            <button type="submit" class="cup shadow-sm p-2 <?= $isSelected ? 'selected' : '' ?>" style="border: none;">
